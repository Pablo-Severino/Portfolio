      ...
      <main className={styled.main}>
            ...
            <div className={styled.preview1}>
              <div className={styled.previewbg1}>
                <Link href="https://stack-bitz.vercel.app" target="_blank">
                  <Image src={stackbitz} alt="project demo" className={styled.stackbitz} />
                </Link>
              </div>
            </div>
            <div className={styled.description1}>
              <h1>StackBitz UI</h1>
              <p>StackBitz is a website of UI components, created with Tailwind CSS, Utilizing React, JavaScript, Next.js, Tailwind CSS, Firebase</p>
              ...
              <Link href="https://github.com/Pablo-Severino/StackBitz-UI" target="_blank">
                <Image src={linkgithub} alt="logotipo github" className={styled.github1} />
              </Link>
              <Link href="https://stack-bitz.vercel.app" target="_blank">
                <Image src={link} alt="logotipo link" className={styled.link1} />
              </Link>
            </div>
          </div>
            ...
            <div className={styled.preview2}>
              <div className={styled.previewbg2}>
                <Link href="https://sakai-ui.vercel.app">
                  <Image src={sakai} alt="project demo" className={styled.sakai} />
                </Link>
              </div>
            </div>
            <div className={styled.description2}>
              <h1>Sakai UI</h1>
              <p>Sakai UI is a theming website, using React, TypeScript, Next.js, Firebase, JWT</p>
              <div className={styled.tecnolog1}>
              ...
              <Link href="https://github.com/Pablo-Severino/Sakai-UI" target="_blank">
                <Image src={linkgithub} alt="logotipo github" className={styled.github2} />
              </Link>
              <Link href="https://sakai-ui.vercel.app" target="_blank">
                <Image src={link} alt="logotipo link" className={styled.link2} />
              </Link>
            </div>
          </div>
            ...
            <div className={styled.preview1}>
              <div className={styled.previewbg1}>
                <Link href="https://galaxy-films.vercel.app">
                  <Image src={galaxy} alt="project demo" className={styled.galaxy} />
                </Link>
              </div>
            </div>
            <div className={styled.description3}>
              <h1>Galaxy Films</h1>
              <p>Galaxy Films is a NetFlix clone, using React, JavaScript, Next.js, Firebase, React Icons</p>
              <div className={styled.tecnolog1}>
                <div className={styled.space1}>
                  <span className={styles.bxreact}>
                    <h4>React</h4>
              ...
              <Link href="https://github.com/Pablo-Severino/Galaxy-Films" target="_blank">
                <Image src={linkgithub} alt="logotipo github" className={styled.github1} />
              </Link>
        ...
        <div className={styled.skills}>
          ...
          <div className={styled.tools}>
            <div className={styled.javascript}>
              <Image src={javascript} alt="logo javascript" className={styled.js} />
              <p>Javascript</p>
            </div>
            <div className={styled.react}>
              <Image src={react} alt="logo reactjs" className={styled.reactjs} />
              <p>React JS</p>
            </div>
            ...
            <div className={styled.mongodb}>
              <Image src={mongodb} alt="logo mongodb" className={styled.mongo} />
              <p>MongoDB</p>
            </div>
            <div className={styled.typescript}>
              <Image src={typescript} alt="logo typescript" className={styled.ts} />
              <p>Typescript</p>
            </div>
            <div className={styled.tailwindcss}>
              <Image src={tailwindcss} alt="logo tailwindcss" className={styled.tailwind} />
              <p>Tailwind CSS</p>
            </div>
            ...
            <div className={styled.github}>
              <Image src={github} alt="logo github" className={styled.githubimg} />
              <p>GitHub</p>
            </div>
            ...
            <div className={styled.vscode}>
              <Image src={vscode} alt="logo vscode" className={styled.vscodeimg} />
              <p>VSCode</p>
            </div>
        ...
        <div className={styled.contacts}>
          ...
          <div className={styled.contact}>
            <Link href="https://mailto:pabloseverino40@gmail.com" target="_blank">
              <h4>pabloseverino40@gmail.com</h4>
            </Link>
            <Link href="https://www.linkedin.com/in/pablo-severino-b23883207" target="_blank">
              <div className={styled.space13}>
                <span>
                  <Image src={linkedin} alt="logo linkedin" className={styled.linkedinlogo} />
            ...
            <Link href="https://github.com/Pablo-Severino" target="_blank">
              <div className={styled.space14}>
                <span>
                  <Image src={linkgithub} alt="logo github" className={styled.githublogo} />
