    ...
    <div id="contact" className="absolute w-[100%] h-[532px] left-0 top-[3202px]">
      ...
      <div className="absolute w-[273px] h-[119px] left-[17vw] top-[281px]">
        <div className="absolute w-[261px] h-[38px] left-0 top-[81px]">
          <Link href="https://github.com/Pablo-Severino" className=" hover:cursor-mickey-hover hover:opacity-70 transition-all duration-200">
          ...
          <Link href="https://www.linkedin.com/in/pablo-severino-b23883207" className=" hover:cursor-mickey-hover hover:opacity-70 transition-all duration-200">
